...
const featurePath = new URL('../../tests/api/bdd/api-tests.feature', import.meta.url);
const content = `Feature: API Publica - JSONPlaceholder
  Como QA Sênior
  ...
  Scenario: Criar post duplicado retorna 201 ou 400
...
console.log('BDD feature file generated at', featurePath.pathname);
